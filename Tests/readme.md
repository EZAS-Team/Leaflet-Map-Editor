...
.js test files should be named `test.js` and follow this format:

```js
//test file that is imported : Name : MM/DD/YYYY
...
//each test should check valid and invalid outputs and update the results variable accordingly
...
Here is part of geoJson.js as and exaple of a test file:
